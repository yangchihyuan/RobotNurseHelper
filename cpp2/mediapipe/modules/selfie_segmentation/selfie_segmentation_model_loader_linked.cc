...
#include "mediapipe/modules/selfie_segmentation/selfie_segmentation_model_loader.inc"
    ;  // NOLINT(whitespace/semicolon)

class SelfieSegmentationModelLoader : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(SelfieSegmentationModelLoader);
// clang-format on

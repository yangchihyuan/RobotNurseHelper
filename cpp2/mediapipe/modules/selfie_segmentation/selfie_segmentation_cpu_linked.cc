...
#include "mediapipe/modules/selfie_segmentation/selfie_segmentation_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class SelfieSegmentationCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(SelfieSegmentationCpu);
// clang-format on

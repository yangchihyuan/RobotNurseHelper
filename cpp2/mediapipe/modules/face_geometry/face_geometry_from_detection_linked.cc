...
#include "mediapipe/modules/face_geometry/face_geometry_from_detection.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceGeometryFromDetection : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceGeometryFromDetection);
// clang-format on

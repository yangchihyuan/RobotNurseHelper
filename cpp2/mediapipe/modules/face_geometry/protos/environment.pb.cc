...
const uint32_t TableStruct_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::mediapipe::face_geometry::PerspectiveCamera)},
  { 12, 20, -1, sizeof(::mediapipe::face_geometry::Environment)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto = {
  false, false, 457, descriptor_table_protodef_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto, "mediapipe/modules/face_geometry/protos/environment.proto", 
  &descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto::offsets,
  file_level_metadata_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto, file_level_enum_descriptors_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto, file_level_service_descriptors_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto_getter() {
  return &descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto(&descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto);
namespace mediapipe {
namespace face_geometry {
...
PerspectiveCamera::PerspectiveCamera(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:mediapipe.face_geometry.PerspectiveCamera)
}
...
inline void PerspectiveCamera::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&vertical_fov_degrees_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&far_) -
    reinterpret_cast<char*>(&vertical_fov_degrees_)) + sizeof(far_));
}
...
inline void PerspectiveCamera::SharedDtor() {
...
uint8_t* PerspectiveCamera::_InternalSerialize(
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData PerspectiveCamera::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    PerspectiveCamera::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*PerspectiveCamera::GetClassData() const { return &_class_data_; }

void PerspectiveCamera::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<PerspectiveCamera *>(to)->MergeFrom(
      static_cast<const PerspectiveCamera &>(from));
}
...
void PerspectiveCamera::InternalSwap(PerspectiveCamera* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PerspectiveCamera, far_)
      + sizeof(PerspectiveCamera::far_)
      - PROTOBUF_FIELD_OFFSET(PerspectiveCamera, vertical_fov_degrees_)>(
          reinterpret_cast<char*>(&vertical_fov_degrees_),
          reinterpret_cast<char*>(&other->vertical_fov_degrees_));
}

::PROTOBUF_NAMESPACE_ID::Metadata PerspectiveCamera::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto_getter, &descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto_once,
      file_level_metadata_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto[0]);
}
...
Environment::Environment(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:mediapipe.face_geometry.Environment)
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Environment::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto_getter, &descriptor_table_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto_once,
      file_level_metadata_mediapipe_2fmodules_2fface_5fgeometry_2fprotos_2fenvironment_2eproto[1]);
}
...
template<> PROTOBUF_NOINLINE ::mediapipe::face_geometry::PerspectiveCamera* Arena::CreateMaybeMessage< ::mediapipe::face_geometry::PerspectiveCamera >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mediapipe::face_geometry::PerspectiveCamera >(arena);
}
template<> PROTOBUF_NOINLINE ::mediapipe::face_geometry::Environment* Arena::CreateMaybeMessage< ::mediapipe::face_geometry::Environment >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mediapipe::face_geometry::Environment >(arena);
}

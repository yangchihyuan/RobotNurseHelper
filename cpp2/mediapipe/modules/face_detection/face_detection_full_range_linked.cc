...
#include "mediapipe/modules/face_detection/face_detection_full_range.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceDetectionFullRange : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceDetectionFullRange);
// clang-format on

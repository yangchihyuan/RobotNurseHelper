...
#include "mediapipe/modules/face_landmark/face_landmark_landmarks_to_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceLandmarkLandmarksToRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceLandmarkLandmarksToRoi);
// clang-format on

...
#include "mediapipe/modules/face_landmark/face_landmark_front_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceLandmarkFrontCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceLandmarkFrontCpu);
// clang-format on

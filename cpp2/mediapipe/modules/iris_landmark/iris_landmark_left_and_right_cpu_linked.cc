...
#include "mediapipe/modules/iris_landmark/iris_landmark_left_and_right_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class IrisLandmarkLeftAndRightCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(IrisLandmarkLeftAndRightCpu);
// clang-format on

...
#include "mediapipe/modules/face_detection/face_detection_short_range_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceDetectionShortRangeCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceDetectionShortRangeCpu);
// clang-format on

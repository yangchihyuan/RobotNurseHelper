...
#include "mediapipe/modules/face_detection/face_detection_full_range_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceDetectionFullRangeCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceDetectionFullRangeCpu);
// clang-format on

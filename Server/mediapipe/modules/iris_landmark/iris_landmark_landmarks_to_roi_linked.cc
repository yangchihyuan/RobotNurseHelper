...
#include "mediapipe/modules/iris_landmark/iris_landmark_landmarks_to_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class IrisLandmarkLandmarksToRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(IrisLandmarkLandmarksToRoi);
// clang-format on

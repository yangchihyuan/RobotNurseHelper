        ...
        while (DataFrames_queue.size() > 0) // process all messages in the queue{
        {
            ...
            if (RTSmessage.has_numberpressed())
            {
                ...
                case 1:
                    ...
                    RobotExpressionIndex = RobotCommandProtobuf::RobotCommand::FaceEnum::RobotCommand_FaceEnum_ACTIVE;
                    break;
                case 2:
                    str_RobotSpeakSentence = "二";
                    RobotExpressionIndex = RobotCommandProtobuf::RobotCommand::FaceEnum::RobotCommand_FaceEnum_AWARE_LEFT;
                    break;
                case 3:
                    str_RobotSpeakSentence = "三";
                    RobotExpressionIndex = RobotCommandProtobuf::RobotCommand::FaceEnum::RobotCommand_FaceEnum_AWARE_RIGHT;
                    break;
                case 4:
                    str_RobotSpeakSentence = "四";
                    RobotExpressionIndex = RobotCommandProtobuf::RobotCommand::FaceEnum::RobotCommand_FaceEnum_CONFIDENT;
                    break;
                case 5:
                    str_RobotSpeakSentence = "五";
                    RobotExpressionIndex = RobotCommandProtobuf::RobotCommand::FaceEnum::RobotCommand_FaceEnum_DOUBTING;
                    break;
                }

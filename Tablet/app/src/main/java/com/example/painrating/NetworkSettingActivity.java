    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGoPain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NetworkSettingActivity.this, PainActivity.class);
        ...
        btnGoVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(NetworkSettingActivity.this, VideoActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnNetworkSetting.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(NetworkSettingActivity.this, NetworkSettingActivity.class);
                startActivity(intent);
            }
        });
    }

...
class WeightedLandmarkRef final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mediapipe.face_geometry.WeightedLandmarkRef) */ {
 public:
  inline WeightedLandmarkRef() : WeightedLandmarkRef(nullptr) {}
  ~WeightedLandmarkRef() override;
  explicit constexpr WeightedLandmarkRef(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(WeightedLandmarkRef* other) {
    if (other == this) return;
  ...
  WeightedLandmarkRef* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit WeightedLandmarkRef(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  uint32_t landmark_id() const;
  void set_landmark_id(uint32_t value);
  private:
  uint32_t _internal_landmark_id() const;
  void _internal_set_landmark_id(uint32_t value);
  public:
...
class GeometryPipelineMetadata final :
 ...
 public:
  inline GeometryPipelineMetadata() : GeometryPipelineMetadata(nullptr) {}
  ~GeometryPipelineMetadata() override;
  explicit constexpr GeometryPipelineMetadata(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(GeometryPipelineMetadata* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GeometryPipelineMetadata* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GeometryPipelineMetadata(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  PROTOBUF_NODISCARD ::mediapipe::face_geometry::Mesh3d* release_canonical_mesh();
  ...
  public:
  void unsafe_arena_set_allocated_canonical_mesh(
      ::mediapipe::face_geometry::Mesh3d* canonical_mesh);
  ::mediapipe::face_geometry::Mesh3d* unsafe_arena_release_canonical_mesh();
...
inline uint32_t WeightedLandmarkRef::_internal_landmark_id() const {
  return landmark_id_;
}
inline uint32_t WeightedLandmarkRef::landmark_id() const {
  // @@protoc_insertion_point(field_get:mediapipe.face_geometry.WeightedLandmarkRef.landmark_id)
  return _internal_landmark_id();
}
inline void WeightedLandmarkRef::_internal_set_landmark_id(uint32_t value) {
  _has_bits_[0] |= 0x00000001u;
  landmark_id_ = value;
}
inline void WeightedLandmarkRef::set_landmark_id(uint32_t value) {
...
inline void GeometryPipelineMetadata::unsafe_arena_set_allocated_canonical_mesh(
    ::mediapipe::face_geometry::Mesh3d* canonical_mesh) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:mediapipe.face_geometry.GeometryPipelineMetadata.canonical_mesh)
}
...
inline ::mediapipe::face_geometry::Mesh3d* GeometryPipelineMetadata::unsafe_arena_release_canonical_mesh() {
...
inline ::mediapipe::face_geometry::Mesh3d* GeometryPipelineMetadata::mutable_canonical_mesh() {
  ::mediapipe::face_geometry::Mesh3d* _msg = _internal_mutable_canonical_mesh();
    ...
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(canonical_mesh));
...
inline ::mediapipe::face_geometry::WeightedLandmarkRef* GeometryPipelineMetadata::add_procrustes_landmark_basis() {
  ::mediapipe::face_geometry::WeightedLandmarkRef* _add = _internal_add_procrustes_landmark_basis();

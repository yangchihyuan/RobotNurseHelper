...
#include "mediapipe/modules/face_landmark/face_detection_front_detection_to_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceDetectionFrontDetectionToRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceDetectionFrontDetectionToRoi);
// clang-format on

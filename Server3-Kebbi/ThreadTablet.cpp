        ...
        if( pSocketHandler->get_queue_length() > 0 )    //here is an infinite loop
        {
            ...
            switch( faceIndex )
            {
                case 0:
                    ...
                    speed = 120;
                    volume = 50;
                    ZenboExpressionIndex = RobotCommandProtobuf::KebbiCommand::FaceEnum::KebbiCommand_FaceEnum_TTS_JoyA;
                    break;
                case 1:
                    //str_RobotSpeakSentence = "I hope you still bear a little pain.";
                    str_RobotSpeakSentence = "還有一點點痛，看看是不是很快會結束了。";
                    ZenboExpressionIndex = RobotCommandProtobuf::KebbiCommand::FaceEnum::KebbiCommand_FaceEnum_TTS_JoyB;
                    break;
                case 2:
                    //str_RobotSpeakSentence = "Hold on. It will pass soon.";
                    str_RobotSpeakSentence = "忍耐一下，這會很快結束的。";
                    volume = 90;
                    ZenboExpressionIndex = RobotCommandProtobuf::KebbiCommand::FaceEnum::KebbiCommand_FaceEnum_TTS_JoyC;
                    break;
                case 3:
                    ...
                    speed = 70;
                    volume = 60;
                    ZenboExpressionIndex = RobotCommandProtobuf::KebbiCommand::FaceEnum::KebbiCommand_FaceEnum_TTS_SadnessA;
                    break;
                case 4:
                    //str_RobotSpeakSentence = "I am sorry to know that you are very fainful?";
                    str_RobotSpeakSentence = "你要吃一點止痛藥嗎？";
                    ZenboExpressionIndex = RobotCommandProtobuf::KebbiCommand::FaceEnum::KebbiCommand_FaceEnum_TTS_SadnessB;
                    break;
                case 5:
                    //str_RobotSpeakSentence = "Do I need to call the doctor?";
                    str_RobotSpeakSentence = "我需要叫醫生嗎？";
                    ZenboExpressionIndex = RobotCommandProtobuf::KebbiCommand::FaceEnum::KebbiCommand_FaceEnum_TTS_Surprise;
                    break;
            }
            cout << "Pain rate: " << faceIndex *2 << std::endl;
            RobotCommandProtobuf::KebbiCommand report_data;
